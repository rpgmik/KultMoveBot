...
help += "!move info - displays bot code and developer info\n"
...
async def on_message(message):
    ...
    info += "If you notice issues or errors, or would like to make a feature request (or better still, would like to contribute code) please raise an issue at the github repo above, or ping @mik on either of the following Kult Divinity Lost Discord servers:\n"
    info += "- Kult - Elysium\n"
    info += "- Kult Divinity Lost Unoffical Discord"
